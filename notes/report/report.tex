...
\begin{abstract}
    ...
    can slow down standard schemes, e.g. \todo{add "tacking" ref.}
...
\section{Introduction}
    ...
    \begin{itemize}
        ...
        benchmark problems in continuous optimization. \todo{ref artificial article}
...
% ------------------ PROBLEMS
\section{Problem Selection and Analysis}
    \label{sec:problems}
    \medskip
    \todo{reference introduction section, use old markdown file as a guide for this section.}
