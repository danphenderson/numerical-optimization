...
\section{Introduction}
    ...
    \subsection{Continuous Model}
        ...
        \begin{proof}[Sketch]
            ...
            \td{TODO: Consider cleanest way to show that the flow lines are contained in the sublevel sets.}
        \end{proof}
        ...
        \td{
            TODO: Complete the compact-domain formulation of the gradient flow dynamical system and demonstrate
    ...
    \subsection{Optimization Schemes}
        ...
        We formally present a \emph{scheme} for solving \eqref{eq:unconstrained-opt} from some
        starting point $\vct{x}_0 \in \Omega$.
